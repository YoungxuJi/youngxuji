(function() {
	...
	var counterWayPoint = function() {
		let probootstrap_counter = $('#probootstrap-counter');
		if ($(probootstrap_counter).length > 0 ) {
			$(probootstrap_counter).waypoint( function( direction ) {
    ...
    var progressBarControl = function () {
    	let progress_bar_s2 = $(".progress-bar-s2");
        if ($(progress_bar_s2).length > 0) {
            var $progress_bar = $(progress_bar_s2);
